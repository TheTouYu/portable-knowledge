...
- distribution/runtime version: `0.2.0rc3`
...
sha256sum dist/portable_knowledge-0.2.0rc3-py3-none-any.whl
uv venv /absolute/path/to/pkc-runtime --python 3.11
uv pip install --python /absolute/path/to/pkc-runtime/bin/python \
  dist/portable_knowledge-0.2.0rc3-py3-none-any.whl
```

On Windows, calculate the hash with:

```powershell
Get-FileHash .\dist\portable_knowledge-0.2.0rc3-py3-none-any.whl -Algorithm SHA256
```
